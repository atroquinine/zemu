...
pub const SteamInputActionEventCallbackPointer = ?*const fn([*c]t.SteamInputActionEvent_t) callconv(.C) void;
...
pub const FnSteamNetConnectionStatusChanged = ?*const fn([*c]t.SteamNetConnectionStatusChangedCallback_t) callconv(.C) void;
pub const FnSteamNetAuthenticationStatusChanged = ?*const fn([*c]t.SteamNetAuthenticationStatus_t) callconv(.C) void;
pub const FnSteamRelayNetworkStatusChanged = ?*const fn([*c]t.SteamRelayNetworkStatus_t) callconv(.C) void;
pub const FnSteamNetworkingMessagesSessionRequest = ?*const fn([*c]t.SteamNetworkingMessagesSessionRequest_t) callconv(.C) void;
pub const FnSteamNetworkingMessagesSessionFailed = ?*const fn([*c]t.SteamNetworkingMessagesSessionFailed_t) callconv(.C) void;
pub const FnSteamNetworkingFakeIPResult = ?*const fn([*c]t.SteamNetworkingFakeIPResult_t) callconv(.C) void;
...
pub const FSteamNetworkingSocketsDebugOutput = ?*const fn(t.ESteamNetworkingSocketsDebugOutputType, [*c]const u8) callconv(.C) void;
